...
const ROUTES = {
    ...
    WORKSPACE_CATEGORY_ITEMIZED_RECEIPTS_OVER: {
        route: 'workspaces/:policyID/category/:categoryName/itemized-receipts-over',
        getRoute: (policyID: string, categoryName: string) => `workspaces/${policyID}/category/${encodeURIComponent(categoryName)}/itemized-receipts-over` as const,
    },
