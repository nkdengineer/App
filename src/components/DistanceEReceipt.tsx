...
type DistanceEReceiptContentProps = {
    transaction: Transaction;
};

/**
 * The distance e-receipt card itself, sized to its content. Use this when a parent needs the card's natural
 * height (for example to scale it). The default DistanceEReceipt fills its parent with flex1 + ScrollView,
 * which Yoga collapses to zero height inside a content-sized wrapper.
 */
function DistanceEReceiptContent({transaction}: DistanceEReceiptContentProps) {
...
export {DistanceEReceiptContent};
