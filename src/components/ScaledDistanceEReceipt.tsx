...
import {DistanceEReceiptContent} from './DistanceEReceipt';
...
function ScaledDistanceEReceipt({transaction}: ScaledDistanceEReceiptProps) {
    ...
    return (
        ...
        >
            {/*
                Render the card panel, not DistanceEReceipt. That component's root is flex1 + ScrollView so it
                can fill the attachment modal. This wrapper is content-sized (fixed width, no height), and Yoga
                resolves a flex1 child in that situation to 0 height, which is the blank native receipt.
                See https://github.com/Expensify/App/issues/99376.
            */}
            <View
