...
const ONYXKEYS = {
    ...
    /**
     * Maps optimistic agent accountIDs (from CreateAgent) to the real accountIDs assigned by the server.
     * Used by HandleUnusedOptimisticID to rewrite queued agent update/delete requests that still
     * reference the optimistic ID after CreateAgent succeeds.
     */
...
type OnyxValuesMapping = {
    ...
    [ONYXKEYS.OPTIMISTIC_AGENT_ACCOUNT_ID_MAPPING]: Record<string, string | number>;
